...
class ActivityWalletManager : BtsppActivity() {
    ...
    private fun drawCell(layout_parent: LinearLayout, data: JSONObject) {
        ...
        if (!is_locked) {
            ...
            tv_tag_of_account_privilege.setTextColor(resources.getColor(R.color.theme01_textColorFlag))
            ...
            tv_tag_of_capital_privilege.setTextColor(resources.getColor(R.color.theme01_textColorFlag))
            ...
            tv_tag_of_remark_privilege.setTextColor(resources.getColor(R.color.theme01_textColorFlag))
